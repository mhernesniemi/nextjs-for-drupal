...
export default function Accordion({}: AccordionProps) {
  const id = useId();

  return (
    <>
      <div id={id + "accordion-collapse"} data-accordion="collapse">
        <h2 id={id + "accordion-collapse-heading"}>
          <button
            type="button"
        ...
        <div
          id={id + "accordion-collapse-body-1"}
          className="hidden"
